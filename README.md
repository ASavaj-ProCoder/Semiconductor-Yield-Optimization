...
```text
├── uci-secom.csv              # Input dataset (1567 records, 591 features)
├── main.py                    # FINAL PRODUCTION PIPELINE (Feature Selection + Cutoff Tuning)
├── main_baseline.py           # Phase 3 Draft (No Feature Selection Layer)
└── archived_versions/
    ├── phase1_smote.py        # Phase 1 Experiment (Synthetic Over-sampling)
    └── phase2_tuning.py       # Phase 2 Experiment (Tree Weights & Initial Thresholding)
```
